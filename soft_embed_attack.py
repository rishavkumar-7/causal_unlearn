...
def main(cfg):
    ...
    # model_path = "meta-llama/Llama-3.2-1B" if cfg.forget_loss == 'prompt_baseline' else cfg.save_dir
    ...
    for run_ind in range(num_runs):
        ...
        for index in range(0, len(dataset), decode_batch_size):
            ...
            outputs = model.generate(inputs_embeds=input_embeds_bld, attention_mask=attention_mask_bl, max_length=max_generate_tokens, do_sample=False, use_cache=True, pad_token_id=right_tokenizer.eos_token_id,bos_token_id=right_tokenizer.bos_token_id)
