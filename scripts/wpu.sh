...
do
    ...
    then
        ...
        # save_dir=${save_dir_root}/meta-llama/Llama-3.2-1B/${forget_loss}/${num_dist}_${seed}_${split}
    else
        save_dir=${save_dir_root}/meta-llama/Llama-2-7b-chat-hf/${forget_loss}/${seed}_${split}
        # save_dir=${save_dir_root}/meta-llama/Llama-3.2-1B/${forget_loss}/${seed}_${split}
        num_dist=1
    fi
